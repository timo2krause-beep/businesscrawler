...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 bg-gradient-to-br from-slate-50 via-white to-purple-50/30">
      <div className="w-full max-w-[380px]">
        ...
        <div className="rounded-2xl border border-[var(--border)] bg-white p-8 card-shadow">
          ...
          <p className="text-[13px] text-[var(--text-muted)] text-center mb-6">
            Starte jetzt mit der Scraper Platform
          </p>
